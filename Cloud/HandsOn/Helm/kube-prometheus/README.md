...
Note: So each repo has an index of packages/charts it offeres, we can look then at `<repo-url>/index.yaml`
Eg: https://prometheus-community.github.io/helm-charts/index.yaml
